...
let mobile = false;
  ...
  function changeMode() {
    let currentText;
    const mobileText =  "<p>Common Carp <br><img class='mobilepic' onclick='selection(this, true)'> <br>Northern Pike <br><img class='mobilepic' onclick='selection(this, true)'><br>Yellow Perch <br><img class='mobilepic' onclick='selection(this, true)'><br>Rainbow Trout<br><img class='mobilepic' onclick='selection(this, true)'><br>Salmon<br><img class='mobilepic' onclick='selection(this, true)'><br>Catfish<br><img class='mobilepic' onclick='selection(this, true)'><br>Burbot<br><img class='mobilepic' onclick='selection(this, true)'><br>Spotted Brook Trout<br><img class='mobilepic' onclick='selection(this, true)'><br>Pumpkinseed<br><img class='mobilepic' onclick='selection(this, true)'><br>Crayfish<br><img class='mobilepic' onclick='selection(this, true)'><br>Bluegill<br><img class='mobilepic' onclick='selection(this, true)'><br>Brook Trout<br><img class='mobilepic' onclick='selection(this, true)'><br>White Bass<br><img class='mobilepic' onclick='selection(this, true)'><br> White Perch<br><img class='mobilepic' onclick='selection(this, true)'><br></p><button onclick='selection(this, false)'>Clear</button><br> <br> <button onclick='changeMode()'>Switch to desktop view</button><br>";
